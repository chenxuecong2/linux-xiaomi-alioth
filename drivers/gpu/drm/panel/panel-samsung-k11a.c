...
// Copyright (c) 2024 chenxuecong (3148113939@qq.com)
...
static inline
struct k11a_38_08_0a_dsc *to_k11a_38_08_0a_dsc(struct drm_panel *panel)
{
	return container_of(panel, struct k11a_38_08_0a_dsc, panel);
}

static void k11a_38_08_0a_dsc_reset(struct k11a_38_08_0a_dsc *ctx)
{
...
static int k11a_38_08_0a_dsc_on(struct k11a_38_08_0a_dsc *ctx)
{
...
static int k11a_38_08_0a_dsc_off(struct k11a_38_08_0a_dsc *ctx)
{
	struct mipi_dsi_device *dsi = ctx->dsi;
	struct device *dev = &dsi->dev;
	int ret;
...
static int k11a_38_08_0a_dsc_prepare(struct drm_panel *panel)
{
	struct k11a_38_08_0a_dsc *ctx = to_k11a_38_08_0a_dsc(panel);
	struct device *dev = &ctx->dsi->dev;
	struct drm_dsc_picture_parameter_set pps;
	int ret;

	k11a_38_08_0a_dsc_reset(ctx);

	ret = k11a_38_08_0a_dsc_on(ctx);
	if (ret < 0) {
...
static int k11a_38_08_0a_dsc_unprepare(struct drm_panel *panel)
{
	struct k11a_38_08_0a_dsc *ctx = to_k11a_38_08_0a_dsc(panel);
	struct device *dev = &ctx->dsi->dev;
	int ret;

	ret = k11a_38_08_0a_dsc_off(ctx);
	if (ret < 0)
...
static const struct drm_display_mode k11a_38_08_0a_dsc_mode = {
...
static int k11a_38_08_0a_dsc_get_modes(struct drm_panel *panel,
				       struct drm_connector *connector)
{
	return drm_connector_helper_get_modes_fixed(connector, &k11a_38_08_0a_dsc_mode);
}

static const struct drm_panel_funcs k11a_38_08_0a_dsc_panel_funcs = {
	.prepare = k11a_38_08_0a_dsc_prepare,
	.unprepare = k11a_38_08_0a_dsc_unprepare,
	.get_modes = k11a_38_08_0a_dsc_get_modes,
};

static int k11a_38_08_0a_dsc_probe(struct mipi_dsi_device *dsi)
{
	struct device *dev = &dsi->dev;
	struct k11a_38_08_0a_dsc *ctx;
	int ret;
	...
	drm_panel_init(&ctx->panel, dev, &k11a_38_08_0a_dsc_panel_funcs,
...
static void k11a_38_08_0a_dsc_remove(struct mipi_dsi_device *dsi)
{
	struct k11a_38_08_0a_dsc *ctx = mipi_dsi_get_drvdata(dsi);
	int ret;
...
static struct mipi_dsi_driver k11a_38_08_0a_dsc_driver = {
	.probe = k11a_38_08_0a_dsc_probe,
	.remove = k11a_38_08_0a_dsc_remove,
	.driver = {
		.name = "panel-k11a-38-08-0a-dsc",
		.of_match_table = k11a_38_08_0a_dsc_of_match,
	},
};
module_mipi_dsi_driver(k11a_38_08_0a_dsc_driver);

MODULE_AUTHOR("3148113939@qq.com");
